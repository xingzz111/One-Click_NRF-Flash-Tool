...
class PCA9554EmulatorPlugin(object):

    def __init__(self):
        self._reg = dict()
        self.write(0x00, [PCA9554Def.INTPUT_PORT_REGISTERS, 0x00, 0x00])
        self.write(0x00, [PCA9554Def.OUTPUT_PORT_REGISTERS, 0xFF, 0xFF])
        self.write(0x00, [PCA9554Def.POLARITY_INVERSION_REGISTERS, 0x00, 0x00])
        self.write(0x00, [PCA9554Def.DIR_CONFIGURATION_REGISTERS, 0xFF, 0xFF])
    ...
    def read(self, addr, wr_data, wr_len):
        raise NotImplementedError('PCA9554 no need to implement this function')
