...
from mix.driver.smartgiant.dazzler.module.dazzler import Dazzler
...
def create_dazzler_dbg(fftrt_dev, i2s_rx_en_pin, adc_rst_pin, gpio_dev,
    ...
    if mix_aut1_dev != '':
        ...
        dazzler_dbg.audio = Dazzler(i2c_bus, analyzer=analyzer, signal_source=signal_source,
                                    adc_rst_pin=analyzer_rst, i2s_rx_en_pin=analyzer_en,
...
if __name__ == '__main__':
    ...
    dazzler_dbg = create_dazzler_dbg(args.fftrt_device, args.i2s_rx_en_pin, args.adc_reset_pin, args.gpio,
