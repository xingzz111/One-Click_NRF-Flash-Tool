...
from mix.driver.smartgiant.negasonic.module.audio002002_map import Negasonic
...
def create_negasonic_dbg(fftrt_dev, i2s_rx_en_pin, adc_rst_pin, gpio_dev,
    ...
    if mix_aut1_dev != '':
        ...
        audio002002_dbg.audio = Negasonic(i2c_bus, analyzer=analyzer, signal_sourc=signal_source,
...
if __name__ == '__main__':
    ...
    audio002002_dbg = create_negasonic_dbg(args.fftrt_device, args.i2s_rx_en_pin, args.adc_reset_pin, args.gpio,
                                           args.signal_source_device, args.i2s_tx_en_pin,
                                           args.dac_reset_pin, args.i2c_device, args.mix_aut1)
    audio002002_dbg.cmdloop()
