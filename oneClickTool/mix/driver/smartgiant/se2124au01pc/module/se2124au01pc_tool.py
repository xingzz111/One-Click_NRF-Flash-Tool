...
from mix.driver.smartgiant.se2124au01pc.module.se2124au01pc import SE2124AU01PC
...
class SE2124AU01PCDebuger(cmd.Cmd):
    prompt = 'se2124au01pc>'
    intro = 'se2124au01pc debug tool'
...
def create_se2124au01pc_dbg(fftrt_dev, i2s_rx_en_pin, adc_rst_pin, gpio_dev,
                            signal_source_dev, i2s_tx_en_pin, dac_rst_pin,
                            i2c_dev, mix_aut1_dev):

    se2124au01pc_dbg = SE2124AU01PCDebuger()
    ...
    if mix_aut1_dev != '':
        ...
        se2124au01pc_dbg.audio = SE2124AU01PC(i2c_bus, ip=mix_aut1)
    else:
...
if __name__ == '__main__':
    ...
    se2124au01pc_dbg = create_se2124au01pc_dbg(args.fftrt_device, args.i2s_rx_en_pin, args.adc_reset_pin, args.gpio,
                                               args.signal_source_device, args.i2s_tx_en_pin,
                                               args.dac_reset_pin, args.i2c_device, args.mix_aut1)
    se2124au01pc_dbg.cmdloop()
