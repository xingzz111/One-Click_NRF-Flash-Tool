...
from mix.driver.smartgiant.luggage.module.luggage import Luggage
...
class LuggageDebuger(cmd.Cmd):
    prompt = 'luggage>'
    intro = 'Xavier luggage debug tool, Type help or ? to list commands.\n'
    ...
    def do_init_to(self, line):
        ...
        self.luggage.init_to(*list(eval(line)))
        print("Done.")
    ...
    def do_set_CC(self, line):
        ...
        line = line.replace(' ', ',')
        self.luggage.set_CC(*list(eval(line)))
        print("Done.")
    ...
    def do_set_CV(self, line):
        ...
        line = line.replace(' ', ',')
        self.luggage.set_CV(*list(eval(line)))
        print("Done.")
    ...
    def do_set_CR(self, line):
        ...
        line = line.replace(' ', ',')
        self.luggage.set_CR(*list(eval(line)))
        print("Done.")
    ...
    def do_read_local_temperature(self, line):
        ...
        result = self.luggage.read_local_temperature()
        print("Result:")
        print(result)
    ...
    def do_read_remote_temperature(self, line):
        ...
        result = self.luggage.read_remote_temperature()
        print("Result:")
        print(result)
    ...
    def do_write_CRoffset(self, line):
        ...
        self.luggage.write_CRoffset(*list(eval(line)))
        print("Done.")
    ...
    def do_read_CRoffset(self, line):
        ...
        result = self.luggage.read_CRoffset()
        print("Result:")
        print(result)
    ...
    def do_usb_connect_set(self, line):
        ...
        self.luggage.usb_connect_set(*list(eval(line)))
        print("Done.")
    ...
    def do_write_calibration(self, line):
        ...
        line = line.replace(' ', ',')
        self.luggage.write_calibration(*list(eval(line)))
        print("Done.")
    ...
    def do_read_calibration(self, line):
        ...
        result = self.luggage.read_calibration(*list(eval(line)))
        print("Result:")
        print(result)
    ...
    def do_erase_calibration(self, line):
        ...
        self.luggage.erase_calibration(*list(eval(line)))
        print("Done.")
    ...
    def do_write_eeprom(self, line):
        ...
        line = line.replace(' ', ',')
        self.luggage.write_eeprom(*list(eval(line)))
        print("Done.")
    ...
    def do_read_eeprom(self, line):
        ...
        line = line.replace(' ', ',')
        result = self.luggage.read_eeprom(*list(eval(line)))
        print("Result:")
        print(result)
    ...
    def do_eeprom_write_string(self, line):
        ...
        line = line.replace(' ', ',')
        self.luggage.eeprom_write_string(*list(eval(line)))
        print("Done.")
    ...
    def do_eeprom_read_string(self, line):
        ...
        line = line.replace(' ', ',')
        result = self.luggage.eeprom_read_string(*list(eval(line)))
        print("Result:")
        print(result)
    ...
    def do_get_calibration_mode(self, line):
        ...
        if '?' == line:
            print(get_function_doc(self))
            return None
        result = self.luggage.get_calibration_mode()
        print(result)
    ...
    def do_set_calibration_mode(self, line):
        ...
        if '?' == line:
            print(get_function_doc(self))
            return None
        self.luggage.set_calibration_mode(*list(eval(line)))
        print('Done.')
...
def create_luggage_dbg(i2c_bus_name, spi_bus_name, gpio_device_name, switch_pin_id):
    luggage_dbg = LuggageDebuger()
    ...
    luggage_dbg.luggage = Luggage(i2c=i2c_bus, spi=spi_bus, gpio_switch=gpio_switch)

    return luggage_dbg


arguments = [
    ['-i2c', '--i2c', 'i2c bus name for luggage', '/dev/i2c-0'],
    ['-spi', '--spi', 'spi bus name for luggage', '/dev/MIX_QSPI_0'],
...
if __name__ == '__main__':
    ...
    luggage_dbg = create_luggage_dbg(args.i2c, args.spi, args.gd, args.gpio_switch)
    luggage_dbg.cmdloop()
