...
class PCA9536Debuger(cmd.Cmd):
    prompt = 'pca9536>'
    intro = 'Xavier pca9536 debug tool'

    @handle_errors
    def do_read_register(self, line):
        '''read_register device_address rd_len'''
        line = line.replace(' ', ',')
        data = self.pca9536.read_register(*list(eval(line)))
        print('Result:')
        print(data)
        return
    ...
    def do_write_register(self, line):
        ...
        line = line.replace(' ', ',')
        self.pca9536.write_register(*list(eval(line)))
        print('Done')
        return
    ...
    def do_set_pin_dir(self, line):
        ...
        line = line.replace(' ', ',')
        self.pca9536.set_pin_dir(*list(eval(line)))
        print('Done')
        return
    ...
    def do_get_pin_dir(self, line):
        '''get_pin_dir pin_id'''
        result = self.pca9536.get_pin_dir(eval(line))
        print('Result:')
        print(result)
        return
    ...
    def do_set_pin(self, line):
        ...
        line = line.replace(' ', ',')
        self.pca9536.set_pin(*list(eval(line)))
        print('Done')
        return
    ...
    def do_get_pin(self, line):
        '''get_pin pin_id'''
        result = self.pca9536.get_pin(eval(line))
        print('Result:')
        print(result)
        return
    ...
    def do_get_pin_state(self, line):
        ...
        result = self.pca9536.get_pin_state(eval(line))
        print('Result:')
        print(result)
        return
    ...
    def do_set_pin_inversion(self, line):
        ...
        line = line.replace(' ', ',')
        self.pca9536.set_pin_inversion(*list(eval(line)))
        print('Done')
        return
    ...
    def do_get_pin_inversion(self, line):
        ...
        result = self.pca9536.get_pin_inversion(eval(line))
        print('Result:')
        print(result)
        return
    ...
    def do_set_pins_dir(self, line):
        '''set_pins_dir [data]'''
        line = line.replace(' ', ',')
        self.pca9536.set_pins_dir(eval(line))
        print('Done')
        return
    ...
    def do_get_pins_dir(self, line):
        '''get_pins_dir'''
        result = self.pca9536.get_pins_dir()
        print('Result:')
        print(result)
        return
    ...
    def do_set_ports(self, line):
        '''set_ports [data]'''
        line = line.replace(' ', ',')
        self.pca9536.set_ports(eval(line))
        print('Done')
        return
    ...
    def do_get_ports_state(self, line):
        '''get_ports_state'''
        result = self.pca9536.get_ports_state()
        print('Result:')
        print(result)
        return
    ...
    def do_set_ports_inversion(self, line):
        ...
        line = line.replace(' ', ',')
        self.pca9536.set_ports_inversion(eval(line))
        print('Done')
        return
    ...
    def do_get_ports_inversion(self, line):
        '''get_ports_inversion'''
        result = self.pca9536.get_ports_inversion()
        print('Result:')
        print(result)
...
def create_pca9536_dbg(dev_name, device_address):
    pca9536_dbg = PCA9536Debuger()
    if dev_name == '':
        i2c_bus = None
    else:
    ...
    pca9536_dbg.pca9536 = PCA9536(device_address, i2c_bus)
    return pca9536_dbg
...
if __name__ == '__main__':
    ...
    pca9536_dbg = create_pca9536_dbg(args.device, int(args.address, 16))
