...
from mix.driver.smartgiant.elektra.module.el004002_map import EL004002
...
def create_elektra_dbg(i2c_name, spi_name, ad760x_name, gpio_id, volt_ch_1, volt_ch_2, curr_ch_1, curr_ch_2):
    ...
    scope_dbg.elektra = EL004002(i2c=i2c_bus, spi=spi_bus, ad7608=ad7608_ip, gpio=gpio_bus,
